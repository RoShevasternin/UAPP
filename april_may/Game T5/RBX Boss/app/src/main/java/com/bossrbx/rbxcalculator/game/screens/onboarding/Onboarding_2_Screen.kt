...
class Onboarding_2_Screen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------

    private val aContentImg by lazy { Image(gdxGame.assetsAll.listOnb[1]) }
    ...
    // ------------------------------------------------------------------------
    override fun show() {
        setBackBackground(gdxGame.assetsAll.listOnboarding[1])
    ...
    private fun AConstraintLayout.addNextBtn() {
        ...
        aNextBtn.setOnClickListener {
            animHideScreen {
                gdxGame.navigationManager.navigate(Onboarding_3_Screen::class.java.name, Onboarding_2_Screen::class.java.name)
            }
        }
