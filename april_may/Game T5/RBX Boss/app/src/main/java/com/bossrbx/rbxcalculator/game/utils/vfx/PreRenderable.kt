package com.bossrbx.rbxcalculator.game.utils.vfx
...
//   бо сам preRender() через [com.bossrbx.rbxcalculator.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
