...
import com.rbuxdrop.cougame.game.actors.panel.wheel.ADialog
import com.rbuxdrop.cougame.game.actors.panel.wheel.AWheel
...
class WheelScreen: AdvancedScreen() {
    ...
    private val aPurpleBtn  = APurpleButton(this, "Spin Now")
...
//    }
    ...
    private fun AConstraintLayout.addWheel() {
        aWheel.setSize(392f, 392f)
        add(aWheel) { centerX(); topToBottom(aPanelTop) }
    }
