...
class Head_BodyFaceShapesScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderHead_Body(this, gdxGame.assetsAll.listHead_BodyHeader[1]) }
    private val aPanelSelect by lazy { APanelHead_BodyFaceShapes(this) }
