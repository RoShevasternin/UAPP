...
class APanelAccessoriesAll(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val listContentImg = List(3) { Image(gdxGame.assetsAll.listAccessoriesPanel[it]) }
