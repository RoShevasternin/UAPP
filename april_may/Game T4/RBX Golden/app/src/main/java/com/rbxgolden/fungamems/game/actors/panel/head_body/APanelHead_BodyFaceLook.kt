...
class APanelHead_BodyFaceLook(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val listContentImg = List(1) { Image(gdxGame.assetsAll.listHead_BodyPanel[1]) }
