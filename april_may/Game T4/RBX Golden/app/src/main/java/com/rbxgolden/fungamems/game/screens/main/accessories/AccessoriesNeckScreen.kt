...
import com.rbxgolden.fungamems.game.actors.panel.accessories.APanelAccessoriesHead
import com.rbxgolden.fungamems.game.actors.panel.accessories.APanelAccessoriesNeck
...
class AccessoriesNeckScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderAccessories(this, gdxGame.assetsAll.listAccessoriesHeader[3]) }
    private val aPanelSelect by lazy { APanelAccessoriesNeck(this) }
    ...
    private fun AConstraintLayout.addPanelTop() {
        ...
        aPanelTop.setTitle("All Accessories")
