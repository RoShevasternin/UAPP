...
class APanelAnimationsEmotes(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val listContentImg = List(1) { Image(gdxGame.assetsAll.listAnimationsPanel[0]) }
