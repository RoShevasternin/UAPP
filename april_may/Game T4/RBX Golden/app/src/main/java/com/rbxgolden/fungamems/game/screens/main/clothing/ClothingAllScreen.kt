...
class ClothingAllScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderClothing(this, gdxGame.assetsAll.listClothingHeader[0]) }
    private val aPanelSelect by lazy { APanelClothingAll(this) }
