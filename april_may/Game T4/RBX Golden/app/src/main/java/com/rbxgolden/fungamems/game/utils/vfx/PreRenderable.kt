package com.rbxgolden.fungamems.game.utils.vfx
...
//   бо сам preRender() через [com.rbxgolden.fungamems.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
