...
import com.rbxgolden.fungamems.game.actors.panel.head_body.APanelHead_BodyBodyShapes
...
class Head_BodyBodyShapesScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderHead_Body(this, gdxGame.assetsAll.listHead_BodyHeader[3]) }
    private val aPanelSelect by lazy { APanelHead_BodyBodyShapes(this) }
