...
class AccessoriesFaceScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderAccessories(this, gdxGame.assetsAll.listAccessoriesHeader[1]) }
    private val aPanelSelect by lazy { APanelAccessoriesFace(this) }
