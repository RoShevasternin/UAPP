...
import com.rbxgolden.fungamems.game.actors.panel.APanelSelectAnimationPack
...
class SelectAnimationPackScreen: AdvancedScreen() {
    ...
    private val aPanelSelect by lazy { APanelSelectAnimationPack(this) }
