...
class AccessoriesHeadScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderAccessories(this, gdxGame.assetsAll.listAccessoriesHeader[2]) }
    private val aPanelSelect by lazy { APanelAccessoriesHead(this) }
