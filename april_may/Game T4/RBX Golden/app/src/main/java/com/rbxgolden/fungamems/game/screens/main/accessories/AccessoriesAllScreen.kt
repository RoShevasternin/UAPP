...
class AccessoriesAllScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderAccessories(this, gdxGame.assetsAll.listAccessoriesHeader[0]) }
    private val aPanelSelect by lazy { APanelAccessoriesAll(this) }
