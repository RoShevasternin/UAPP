...
import com.rbxgolden.fungamems.game.actors.panel.head_body.APanelHead_BodyAll
...
class Head_BodyAllScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderHead_Body(this, gdxGame.assetsAll.listHead_BodyHeader[0]) }
    private val aPanelSelect by lazy { APanelHead_BodyAll(this) }
