...
class ClothingT_shirtsScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderClothing(this, gdxGame.assetsAll.listClothingHeader[1]) }
    private val aPanelSelect by lazy { APanelClothingT_shirts(this) }
