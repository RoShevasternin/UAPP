...
import com.rbxgolden.fungamems.game.actors.panel.animations.APanelAnimationsAll
...
class AnimationsAllScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderAnimations(this, gdxGame.assetsAll.listAnimationsHeader[0]) }
    private val aPanelSelect by lazy { APanelAnimationsAll(this) }
