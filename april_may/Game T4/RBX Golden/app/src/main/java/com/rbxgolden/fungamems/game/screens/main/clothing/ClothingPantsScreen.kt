...
class ClothingPantsScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderClothing(this, gdxGame.assetsAll.listClothingHeader[3]) }
    private val aPanelSelect by lazy { APanelClothingPants(this) }
