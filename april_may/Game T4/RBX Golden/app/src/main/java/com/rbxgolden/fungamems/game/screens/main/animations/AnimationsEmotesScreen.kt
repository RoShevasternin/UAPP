...
class AnimationsEmotesScreen: AdvancedScreen() {
    ...
    private val aHeader      by lazy { AHeaderAnimations(this, gdxGame.assetsAll.listAnimationsHeader[1]) }
    private val aPanelSelect by lazy { APanelAnimationsEmotes(this) }
