...
class APanelSelect1(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val listContentImg = List(5) { Image(gdxGame.assetsAll.listS1[it]) }
    private val listContentBox = List(84) { ACheckBox(screen, ACheckBoxStyles.YELLOW) }
    ...
    private fun setUpContentGroup() {
        ...
        aGoldenBtn.setOnClickListener {
            screen.animHideScreen {
                gdxGame.navigationManager.navigate(Select_2_Screen::class.java.name, screen::class.java.name)
            }
        }
    ...
    private fun AdvancedGroup.addListContentImg() {
        val listBounds = listOf(
            Rectangle(16f, 3338f, 343f, 894f),
            Rectangle(16f, 2432f, 343f, 894f),
            Rectangle(16f, 1526f, 343f, 894f),
            Rectangle(16f, 620f, 343f, 894f),
            Rectangle(16f, 16f, 343f, 592f),
        )
