...
import com.skindustry.skinly.game.utils.GLOBAL_listSelectorItem_1
...
class Selector_1_Screen: AdvancedScreen() {
    ...
    private val aDescLbl     by lazy { Label(GLOBAL_listDesc[0], FontFactory.create(this, parameter20, fontGenerator_SemiBold, Color.BLACK)) }
    ...
    private fun AConstraintLayout.addSelector() {
        ...
        aSelector.setTexts(GLOBAL_listSelectorItem_1)
