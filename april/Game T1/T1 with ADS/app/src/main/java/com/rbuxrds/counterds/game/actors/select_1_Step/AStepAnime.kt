...
class AStepAnime(override val screen: AdvancedScreen): AdvancedGroup(), WizardStep, SelectableBox {

    override val group = this
    override val title = "Select Anime"

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aContentImg = Image(gdxGame.assetsAll.SELECT_ANIME)
