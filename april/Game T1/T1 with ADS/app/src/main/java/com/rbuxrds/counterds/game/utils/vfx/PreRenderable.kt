package com.rbuxrds.counterds.game.utils.vfx
...
//   бо сам preRender() через [com.rbuxrds.counterds.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
