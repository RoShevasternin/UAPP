package com.treprosure.starbxup.game.utils.vfx
...
//   бо сам preRender() через [com.treprosure.starbxup.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
