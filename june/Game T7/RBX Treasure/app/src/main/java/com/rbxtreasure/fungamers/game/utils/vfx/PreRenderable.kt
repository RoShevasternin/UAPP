package com.rbxtreasure.fungamers.game.utils.vfx
...
//   бо сам preRender() через [com.rbxtreasure.fungamers.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
