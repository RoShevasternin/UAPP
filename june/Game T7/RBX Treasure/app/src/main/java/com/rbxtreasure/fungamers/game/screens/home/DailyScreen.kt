...
import com.rbxtreasure.fungamers.game.actors.panel.daily.APanelDaily
...
class DailyScreen: AdvancedScreen() {
    ...
    private val aDimImg = Image(drawerUtil.getTexture(GameColor.black_60))
    private val aPopup  = APopupCongratulations(this)
    ...
    private fun AConstraintLayout.addPanelTop() {
        ...
        aPanelTop.setTitle("DAILY TREASURE")
    }

    private fun AConstraintLayout.addPanelDaily() {
        aPanelDaily.width = 343f
        add(aPanelDaily) { centerX(); topToBottom(aPanelTop, 16f); bottomToBottom(); matchHeight() }
