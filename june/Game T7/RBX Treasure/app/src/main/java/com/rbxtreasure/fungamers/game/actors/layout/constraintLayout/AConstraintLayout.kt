package com.rbxtreasure.fungamers.game.actors.layout.constraintLayout
...
import com.rbxtreasure.fungamers.game.utils.global.GlobalEvents
...
open class AConstraintLayout(override val screen: AdvancedScreen) : AdvancedGroup() {
    ...
    private fun unWatchChild(actor: Actor) {
        ...
        if (i >= 0) { childSnapActors.removeAt(i); childSnapArrays.removeAt(i) }
    }
