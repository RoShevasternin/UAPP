...
import com.rbxtreasure.fungamers.game.actors.panel.outfit.data.AccessoriesCategory
import com.rbxtreasure.fungamers.game.actors.panel.outfit.data.AccessoriesData
import com.rbxtreasure.fungamers.game.actors.panel.outfit.data.AnimationsCategory
import com.rbxtreasure.fungamers.game.actors.panel.outfit.data.AnimationsData
...
import com.rbxtreasure.fungamers.game.actors.panel.outfit.data.HeadCategory
import com.rbxtreasure.fungamers.game.actors.panel.outfit.data.HeadData
...
class HeadScreen: AdvancedScreen() {
    ...
    private val filterTabs by lazy {
        HeadCategory.entries.associateWith { cat -> AFilterTab(this, labelStyleTab).apply {
            setSize(1f, 33f)
            setText(cat.title)
        } }
    }
