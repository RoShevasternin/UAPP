...
import com.rbxtreasure.fungamers.game.actors.panel.selector.APanelSelectorRight
...
class Selector_4_Screen: AdvancedScreen() {
    ...
    private val aSelector    by lazy { APanelSelectorRight(this, gdxGame.assetsAll.listSelector[3]) }
