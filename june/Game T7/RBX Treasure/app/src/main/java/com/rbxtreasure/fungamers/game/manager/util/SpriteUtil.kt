package com.rbxtreasure.fungamers.game.manager.util
...
class SpriteUtil {
    ...
    class All {
        ...
        // ALL
        val BOTTOM_BROWN          = SpriteManager.EnumTexture.BOTTOM_BROWN.data.texture
        ...
        val listSelector    = SpriteManager.EnumTextureGroup.SELECTOR.data.textures
