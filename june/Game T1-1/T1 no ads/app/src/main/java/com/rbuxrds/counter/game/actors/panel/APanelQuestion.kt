...
class APanelQuestion(override val screen: AdvancedScreen) : AdvancedGroup() {
    ...
    // Actors
    // ------------------------------------------------------------------------
    private val aPanelImg = Image(gdxGame.assetsAll.panel_question)
    ...
    override fun addActorsOnGroup() {
        ...
        addActor(aTextLbl)
        aTextLbl.setBounds(79f, 7f, 7f, 22f)
    }
