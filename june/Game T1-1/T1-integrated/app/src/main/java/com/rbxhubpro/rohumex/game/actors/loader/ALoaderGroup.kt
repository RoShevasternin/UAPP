package com.rbxhubpro.rohumex.game.actors.loader
        ...
        aLogoImg.apply {
            ...
            addAction(
                Actions.sequence(
                    ...
                    Actions.forever(
                        Actions.sequence(
                            Actions.scaleTo(1.05f, 1.05f, 0.85f, Interpolation.fastSlow),
                            Actions.scaleTo(0.95f, 0.95f, 0.7f, Interpolation.slowFast)
                        )
                    )
                )
            )
