package com.rbxrush.rushrbx.game.utils.font
...
class FontGenerator(fontPath: FontPath): FreeTypeFontGenerator(Gdx.files.internal(fontPath.path)) {
    ...
    companion object {
        enum class FontPath(val path: String) {
            Fredoka_Bold   ("font/Fredoka-Bold.ttf"),
            Fredoka_Regular("font/Fredoka-Regular.ttf"),
            Fredoka_Medium ("font/Fredoka-Medium.ttf"),
        }
    }
