...
class SpriteUtil {
    ...
    class Loader {
        ...
        val LOGO_BACK = SpriteManager.EnumTexture.LOGO_BACK.data.texture
    }
    ...
    class All {
        ...
        val quiz_check     = getAllRegion("quiz_check")
        val quiz_def       = getAllRegion("quiz_def")
        ...
        val panel_daily   = get9PatchScaled("panel_daily", 3)
        ...
        // All | guess
        val GUESS_MORE  = SpriteManager.EnumTexture.GUESS_MORE.data.texture
