package com.rbxrush.rushrbx.game.actors.panel.wheel
...
//    var blockResult: (Result) -> Unit = {}
    ...
    override fun addActorsOnGroup() {
        ...
        addActor(aTargetImg)
        aTargetImg.setBounds(137f, 139f, 70f, 130f)
    }
    ...
    fun spin(blockResult: (winItem: Result) -> Unit) {
        ...
        val randomRotation = (1020..1750).random().toFloat()

        aWheelImg.addAction(
            Actions.sequence(
                Actions.rotateBy(randomRotation, (1..4).random().toFloat(), Interpolation.fastSlow),
                Actions.run {
