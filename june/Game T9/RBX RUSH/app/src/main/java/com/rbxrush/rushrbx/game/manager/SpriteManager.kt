...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumTexture(val data: TextureData) {
        // Loader
        LOGO_BACK(TextureData("textures/loader/logo_back.png")),
        ...
        // All | quess
        GUESS_MORE (TextureData("textures/all/guess/guess_more.png")),
    ...
    enum class EnumTextureGroup(
        ...
        CLOTHING   ("textures/all/selector/clothing"  , "" , 12, ""),
        ANIMATIONS ("textures/all/selector/animation" , "" , 12, ""),
        CHARACTER  ("textures/all/selector/character" , "" , 12, ""),
