...
import com.rbxrush.rushrbx.game.actors.panel.outfit.data.ClothingCategory
import com.rbxrush.rushrbx.game.actors.panel.outfit.data.ClothingData
...
class ClothingScreen: AdvancedScreen() {
    ...
    private val lsCard by lazy { FontFactory.create(this, parameterCard, fontGenerator_Fredoka_Regular) }
