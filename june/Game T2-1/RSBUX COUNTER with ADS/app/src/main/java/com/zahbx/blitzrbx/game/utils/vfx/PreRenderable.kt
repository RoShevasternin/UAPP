package com.zahbx.blitzrbx.game.utils.vfx
...
//   бо сам preRender() через [com.zahbx.blitzrbx.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
