...
import com.zahbx.blitzrbx.adsmodule.AdManager
import com.zahbx.blitzrbx.adsmodule.AdSizeManager
import com.zahbx.blitzrbx.adsmodule.AppOpenManager
import com.zahbx.blitzrbx.adsmodule.RemoteConfigModel
import com.zahbx.blitzrbx.adsmodule.UserDetector
import com.zahbx.blitzrbx.databinding.ActivityMainBinding
import com.zahbx.blitzrbx.game.utils.LINK_JSON
import com.zahbx.blitzrbx.game.utils.runGDX
import com.zahbx.blitzrbx.services.tiktok.TikTokManager
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun openPrivacyPolicy() {
        runOnUiThread {
            val url = "https://vadopruk.github.io/RBX-Blitz/"
            try {
                startActivity(
                    Intent(Intent.ACTION_VIEW).apply {
                        data  = url.toUri()
