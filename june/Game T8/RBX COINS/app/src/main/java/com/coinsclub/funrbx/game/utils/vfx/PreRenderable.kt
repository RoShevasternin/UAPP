package com.coinsclub.funrbx.game.utils.vfx
...
//   бо сам preRender() через [com.coinsclub.funrbx.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
