...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumTexture(val data: TextureData) {
        ...
        BACKGROUND_ONBOARDING(TextureData("textures/all/background_onboarding.png")),
        ...
        PANEL_FREE            (TextureData("textures/all/panel/panel_free.png")),
        ...
        // All | quiz
        QUIZ_CIRCLE_FALSE (TextureData("textures/all/quiz/quiz_circle_false.png")),
        QUIZ_CIRCLE_TRUE  (TextureData("textures/all/quiz/quiz_circle_true.png")),
        QUIZ_FALSE        (TextureData("textures/all/quiz/quiz_false.png")),
        QUIZ_PANEL        (TextureData("textures/all/quiz/quiz_panel.png")),
        QUIZ_TRUE         (TextureData("textures/all/quiz/quiz_true.png")),
        PANEL_QUIZ        (TextureData("textures/all/quiz/panel_quiz.png")),

        // All | home
        CONTENT_3_CLAIM(TextureData("textures/all/home/content_3_claim.png")),
        CONTENT_3_WAIT (TextureData("textures/all/home/content_3_wait.png")),
        ...
        // All | quess
        DESC_QUESS    (TextureData("textures/all/guess/desc_quess.png")),
        GET_FREE_GUESS(TextureData("textures/all/guess/get_free_guess.png")),
    }
