...
val GLOBAL_LIST_CHARACTER_DESCRIPTIONS = listOf(
    ...
    "Lindsey is a smart and fashionable character with a confident personality and modern style. She enjoys social adventures, creative roleplaying, and discovering exciting new places. Her trendy appearance makes her a popular choice for city experiences and hangout games. Perfect for players who love customization and self-expression."
)