package com.coinsclub.funrbx.game.actors.panel.wheel
...
//    var blockResult: (Result) -> Unit = {}
    ...
    fun spin(blockResult: (winItem: Result) -> Unit) {
        ...
        aWheelImg.addAction(
            Actions.sequence(
                Actions.rotateBy(randomRotation, (2..5).random().toFloat(), Interpolation.fastSlow),
                Actions.run {
