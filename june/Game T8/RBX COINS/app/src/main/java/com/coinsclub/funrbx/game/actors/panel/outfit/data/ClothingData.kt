package com.coinsclub.funrbx.game.actors.panel.outfit.data

import com.coinsclub.funrbx.game.actors.panel.outfit.OutfitItem
...
object ClothingData {
    ...
    fun items(): List<OutfitItem<ClothingCategory>> {
        ...
        return listOf(
            ...
            // T-SHIRTS
            OutfitItem("FLORAL BUTTON DOWN"            , ClothingCategory.T_SHIRTS, a.listOutfitClothing[0]),
