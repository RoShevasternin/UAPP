...
import com.coinsclub.funrbx.game.actors.panel.selector.APanelSelectorGrid
import com.coinsclub.funrbx.game.actors.panel.selector.data.ClothingData
...
class Selector_1_Screen: AdvancedScreen() {
    ...
    private val aSelector    by lazy { APanelSelectorGrid(this, ClothingData.items()) }
