package com.fimer.skintool.game.actors.checkbox.base
...
import com.fimer.skintool.game.utils.actor.enable
    ...
    private fun collectCheckFlow() {
        coroutine?.launch {
            checkFlow.collect { isCheck ->
                runGDX { if (isInvokeCheckBlock) onCheckBlock(isCheck) }
            }
        }
    }
