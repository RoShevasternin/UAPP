package com.fimer.skintool.game.screens.home.selectors.emotes
...
import com.fimer.skintool.game.actors.panel.selectors.emotes.APanelEmotes
import com.fimer.skintool.game.data.selectors.EmotesData
...
import com.fimer.skintool.game.utils.global.GLOBAL_EMOTES_INDEX
import com.fimer.skintool.game.utils.runGDX
import kotlinx.coroutines.launch

class EmotesScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelEmotes(this) }
    ...
    private fun AConstraintLayout.addTop() {
        ...
        aTop.setTitle(EmotesData.items()[GLOBAL_EMOTES_INDEX].name)
    }
