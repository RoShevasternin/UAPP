package com.fimer.skintool.game.screens.home.select
...
import com.fimer.skintool.game.actors.panel.select.APanelSelectCategory
import com.fimer.skintool.game.actors.panel.select.APanelSelectId
import com.fimer.skintool.game.actors.panel.select.APanelSelectRank
import com.fimer.skintool.game.actors.panel.select.APanelSelectSkin
...
class SelectSkinScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelSelectSkin(this) }
    ...
    private fun AConstraintLayout.addTop() {
        ...
        aTop.setTitle("SELECT SKIN TOOLS")
    }
