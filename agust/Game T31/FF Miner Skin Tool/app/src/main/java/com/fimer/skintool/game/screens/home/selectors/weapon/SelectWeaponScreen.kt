...
import com.fimer.skintool.game.actors.panel.selectors.weapon.APanelSelectWeapon
...
class SelectWeaponScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelSelectWeapon(this) }
