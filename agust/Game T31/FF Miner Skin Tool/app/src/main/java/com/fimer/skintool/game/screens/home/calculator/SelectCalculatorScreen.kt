...
import com.fimer.skintool.game.actors.panel.tips.APanelSelectTips
import com.fimer.skintool.game.actors.panel.APanelTop
import com.fimer.skintool.game.actors.panel.calculator.APanelSelectCalculator
...
class SelectCalculatorScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelSelectCalculator(this) }
    ...
    private fun AConstraintLayout.addSelect() {
        ...
        coroutine?.launch { AdSizeManager.adBottomFlow.collect {
            runGDX { update(aSelect) { marginBottom = screen.adBottomUI + 30f } }
        } }
    }
