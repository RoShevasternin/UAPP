package com.fimer.skintool.game.screens.home.selectors.pets
...
import com.fimer.skintool.game.actors.panel.selectors.pets.APanelPets
import com.fimer.skintool.game.data.selectors.PetsData
...
class PetsScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelPets(this) }
    ...
    private fun AConstraintLayout.addTop() {
        ...
        aTop.setTitle(PetsData.items()[GLOBAL_PETS_INDEX].name)
    }
