package com.fimer.skintool.game.actors.panel.selectors.weapon
...
class APanelSelectWeapon(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val aContent = Image(gdxGame.assetsAll.WEAPON)
        ...
        listItemBox.forEachIndexed { index, box ->
            ...
            box.setOnTouchListener {
                screen.animHideScreen {
                    GLOBAL_WEAPON_INDEX = index
                    gdxGame.navigationManager.navigate(WeaponScreen::class.java.name, screen::class.java.name)
                }
            }
