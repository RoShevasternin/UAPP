...
import com.fimer.skintool.game.actors.panel.selectors.bundles.APanelSelectBundles
...
class SelectBundlesScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelSelectBundles(this) }
