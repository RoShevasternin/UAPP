package com.fimer.skintool.game.screens.home.selectors.bundles
...
import com.fimer.skintool.game.actors.panel.selectors.bundles.APanelBundles
import com.fimer.skintool.game.data.selectors.BundlesData
...
import com.fimer.skintool.game.utils.global.GLOBAL_BUNDLES_INDEX
import com.fimer.skintool.game.utils.runGDX
import kotlinx.coroutines.launch

class BundlesScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelBundles(this) }
    ...
    private fun AConstraintLayout.addTop() {
        ...
        aTop.setTitle(BundlesData.items()[GLOBAL_BUNDLES_INDEX].name)
    }
