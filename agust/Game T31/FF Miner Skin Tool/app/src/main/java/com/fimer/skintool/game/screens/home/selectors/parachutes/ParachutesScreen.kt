package com.fimer.skintool.game.screens.home.selectors.parachutes
...
import com.fimer.skintool.game.actors.panel.selectors.parachutes.APanelParachutes
...
class ParachutesScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelParachutes(this) }
    ...
    private fun AConstraintLayout.addTop() {
        ...
        aTop.setTitle(ParachutesData.items()[GLOBAL_PARACHUTES_INDEX].name)
    }
