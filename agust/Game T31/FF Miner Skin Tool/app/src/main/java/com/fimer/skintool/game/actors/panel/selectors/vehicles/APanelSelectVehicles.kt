package com.fimer.skintool.game.actors.panel.selectors.vehicles
...
import com.fimer.skintool.game.utils.global.GLOBAL_VEHICLES_INDEX

class APanelSelectVehicles(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val aContent = Image(gdxGame.assetsAll.VEHICLES)
        ...
        listItemBox.forEachIndexed { index, box ->
            ...
            box.setOnTouchListener {
                screen.animHideScreen {
                    GLOBAL_VEHICLES_INDEX = index
                    gdxGame.navigationManager.navigate(VehiclesScreen::class.java.name, screen::class.java.name)
                }
            }
