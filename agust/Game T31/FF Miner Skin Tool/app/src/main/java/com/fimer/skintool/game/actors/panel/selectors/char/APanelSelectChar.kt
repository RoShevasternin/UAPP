package com.fimer.skintool.game.actors.panel.selectors.char
...
class APanelSelectChar(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val aContent = Image(gdxGame.assetsAll.CHAR)
        ...
        listItemBox.forEachIndexed { index, box ->
            ...
            box.setOnTouchListener {
                screen.animHideScreen {
                    GLOBAL_CHAR_INDEX = index
                    gdxGame.navigationManager.navigate(CharScreen::class.java.name, screen::class.java.name)
                }
            }
