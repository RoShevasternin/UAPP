package com.fimer.skintool.game.actors.panel.selectors.emotes
...
class APanelSelectEmotes(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val aContent = Image(gdxGame.assetsAll.EMOTES)
        ...
        listItemBox.forEachIndexed { index, box ->
            ...
            box.setOnTouchListener {
                screen.animHideScreen {
                    GLOBAL_EMOTES_INDEX = index
                    gdxGame.navigationManager.navigate(EmotesScreen::class.java.name, screen::class.java.name)
                }
            }
