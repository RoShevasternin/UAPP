package com.fimer.skintool.game.actors.panel.selectors.bundles
...
class APanelSelectBundles(override val screen: AdvancedScreen): AConstraintLayout(screen) {
    ...
    private val aContent = Image(gdxGame.assetsAll.BUNDLES)
        ...
        listItemBox.forEachIndexed { index, box ->
            ...
            box.setOnTouchListener {
                screen.animHideScreen {
                    GLOBAL_BUNDLES_INDEX = index
                    gdxGame.navigationManager.navigate(BundlesScreen::class.java.name, screen::class.java.name)
                }
            }
