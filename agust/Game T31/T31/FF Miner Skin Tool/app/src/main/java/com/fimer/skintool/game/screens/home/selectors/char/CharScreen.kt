package com.fimer.skintool.game.screens.home.selectors.char
...
import com.fimer.skintool.game.actors.panel.selectors.char.APanelChar
import com.fimer.skintool.game.data.selectors.CharData
...
import com.fimer.skintool.game.utils.global.GLOBAL_CHAR_INDEX
import com.fimer.skintool.game.utils.runGDX
import kotlinx.coroutines.launch

class CharScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelChar(this) }
    ...
    private fun AConstraintLayout.addTop() {
        ...
        aTop.setTitle(CharData.items()[GLOBAL_CHAR_INDEX].name)
    }
