...
import com.fimer.skintool.game.actors.panel.selectors.vehicles.APanelVehicles
import com.fimer.skintool.game.data.selectors.VehiclesData
...
class VehiclesScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelVehicles(this) }
    ...
    private fun AConstraintLayout.addTop() {
        ...
        aTop.setTitle(VehiclesData.items()[GLOBAL_VEHICLES_INDEX].name)
    }
