package com.fimer.skintool.game.screens.home.selectors.weapon
...
import com.fimer.skintool.game.actors.panel.selectors.weapon.APanelWeapon
import com.fimer.skintool.game.data.selectors.WeaponData
...
import com.fimer.skintool.game.utils.global.GLOBAL_WEAPON_INDEX
import com.fimer.skintool.game.utils.runGDX
import kotlinx.coroutines.launch

class WeaponScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelWeapon(this) }
    ...
    private fun AConstraintLayout.addTop() {
        ...
        aTop.setTitle(WeaponData.items()[GLOBAL_WEAPON_INDEX].name)
    }
