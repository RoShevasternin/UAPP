...
import com.fimer.skintool.game.actors.panel.selectors.char.APanelSelectChar
...
class SelectCharScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelSelectChar(this) }
