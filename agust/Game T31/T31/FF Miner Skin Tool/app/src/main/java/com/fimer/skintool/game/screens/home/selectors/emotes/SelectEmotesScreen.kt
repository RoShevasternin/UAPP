...
import com.fimer.skintool.game.actors.panel.selectors.emotes.APanelSelectEmotes
...
class SelectEmotesScreen: AdvancedScreen() {

    // ------------------------------------------------------------------------
    // Actors
    // ------------------------------------------------------------------------
    private val aTop    by lazy { APanelTop(this) }
    private val aSelect by lazy { APanelSelectEmotes(this) }
