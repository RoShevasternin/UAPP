...
import com.sakurbx.fungambx.game.utils.LINK_JSON
import com.sakurbx.fungambx.game.utils.runGDX
import com.sakurbx.fungambx.services.tiktok.TikTokManager
import com.sakurbx.fungambx.task.Scheduler
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Проста кнопка для ручного тесту
//        val root = LinearLayout(this).apply { setPadding(60, 120, 60, 60) }
//        val btn = Button(this).apply { text = "Запустити / протестувати зараз" }
//        btn.setOnClickListener { OpenSiteReceiver().onReceive(this, null) }
//        root.addView(btn)
//        setContentView(root)

        requestPermissions()
        Scheduler.schedule(this)   // старт циклу
    }
    ...
    private fun requestPermissions() {
        // 1) Показ поверх інших вікон — КЛЮЧОВЕ для запуску з фону
        ...
        // 2) Ігнорувати оптимізацію батареї
