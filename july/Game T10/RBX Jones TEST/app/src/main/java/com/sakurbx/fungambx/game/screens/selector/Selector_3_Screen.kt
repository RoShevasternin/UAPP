...
import com.sakurbx.fungambx.game.actors.panel.selector.data.AnimationData
...
class Selector_3_Screen: AdvancedScreen() {
    ...
    private val aSelector    by lazy { APanelSelectorGrid(this, CharacterData.items(), margin = 18f, vSize = Vector2(104f, 104f)) }
