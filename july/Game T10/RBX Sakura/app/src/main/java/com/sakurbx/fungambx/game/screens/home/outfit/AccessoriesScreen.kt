...
import com.sakurbx.fungambx.game.actors.panel.outfit.data.AccessoriesCategory
import com.sakurbx.fungambx.game.actors.panel.outfit.data.AccessoriesData
import com.sakurbx.fungambx.game.actors.panel.outfit.data.ClothingCategory
import com.sakurbx.fungambx.game.actors.panel.outfit.data.ClothingData
...
class AccessoriesScreen: AdvancedScreen() {
    ...
    private val lsTab  by lazy { FontFactory.create(this, parameterTab, fontGenerator_Kedebideri_Bold) }
    ...
    private val filterTabs by lazy {
        AccessoriesCategory.entries.associateWith { cat -> AFilterTab(this, lsTab).apply {
            setSize(1f, 34f)
            setText(cat.title)
        } }
    }
    ...
    private val controller by lazy {
        OutfitController(
            ...
            items       = AccessoriesData.items(),
            allCategory = AccessoriesCategory.ALL,
        )
    }
    ...
    private fun AConstraintLayout.addPanelTop() {
        ...
        aPanelTop.setTitle("ACCESSORIES")
    }

    private fun AConstraintLayout.addPanelFilter() {
        aPanelFilter.height = 34f
