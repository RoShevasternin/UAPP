package com.sakurbx.fungambx.game.utils.vfx
...
//   бо сам preRender() через [com.sakurbx.fungambx.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
