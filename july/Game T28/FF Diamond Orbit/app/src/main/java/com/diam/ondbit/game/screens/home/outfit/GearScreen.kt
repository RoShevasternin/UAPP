...
class GearScreen: AdvancedScreen() {
    ...
    private val filterTabs by lazy {
        GearCategory.entries.associateWith { cat -> AFilterTab(this, lsTab).apply {
            setSize(1f, 36f)
            setText(cat.title)
        } }
    }
