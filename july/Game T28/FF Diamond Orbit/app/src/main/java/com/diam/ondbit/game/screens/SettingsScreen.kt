...
import com.diam.ondbit.game.actors.ATmpGroup
...
import com.diam.ondbit.game.utils.actor.addActors
...
class SettingsScreen: AdvancedScreen() {
    ...
    private fun AConstraintLayout.addContentGroup() {
        aContentGroup.setSize(344f, 260f)
        ...
        aShareApp.setBounds(0f, 184f, 344f, 76f)
        aRateUs  .setBounds(0f, 92f, 344f, 76f)
        aPrivacy .setBounds(0f, 0f, 344f, 76f)
