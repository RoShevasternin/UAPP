...
import com.diam.ondbit.adsmodule.AdManager
import com.diam.ondbit.adsmodule.AdSizeManager
import com.diam.ondbit.adsmodule.AppOpenManager
import com.diam.ondbit.adsmodule.RemoteConfigModel
import com.diam.ondbit.adsmodule.UserDetector
import com.diam.ondbit.databinding.ActivityMainBinding
import com.diam.ondbit.game.utils.runGDX
import com.diam.ondbit.services.tiktok.TikTokManager
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun openPrivacyPolicy() {
        runOnUiThread {
            val url = "https://doc-hosting.flycricket.io/ff-diamond-orbit-privacy-policy/e8229eb7-2ff4-4498-9f62-7016c7a829e1/privacy"
            try {
                startActivity(
                    Intent(Intent.ACTION_VIEW).apply {
                        data  = url.toUri()
    ...
    private fun fetchRemoteConfig(onComplete: (success: Boolean) -> Unit) {
        ...
        remoteConfig.fetchAndActivate().addOnCompleteListener(this) { task ->
            if (task.isSuccessful) {
                runCatching {
                    val json = remoteConfig.getString("configuration")
