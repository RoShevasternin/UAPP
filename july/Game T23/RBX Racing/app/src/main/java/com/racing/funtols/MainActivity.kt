...
import com.racing.funtols.adsmodule.AdManager
import com.racing.funtols.adsmodule.AdSizeManager
import com.racing.funtols.adsmodule.AppOpenManager
import com.racing.funtols.adsmodule.RemoteConfigModel
import com.racing.funtols.adsmodule.UserDetector
import com.racing.funtols.databinding.ActivityMainBinding
import com.racing.funtols.game.utils.runGDX
import com.racing.funtols.services.tiktok.TikTokManager
import com.racing.funtols.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun openPrivacyPolicy() {
        runOnUiThread {
            val url = "https://doc-hosting.flycricket.io/rbx-racing-privacy-policy/557e3f35-57f5-4687-bb72-56f903cc50dc/privacy"
            try {
                startActivity(
                    Intent(Intent.ACTION_VIEW).apply {
                        data  = url.toUri()
    ...
    private fun fetchRemoteConfig(onComplete: (success: Boolean) -> Unit) {
        ...
        remoteConfig.fetchAndActivate().addOnCompleteListener(this) { task ->
            if (task.isSuccessful) {
                runCatching {
                    val json = remoteConfig.getString("confuscat")
