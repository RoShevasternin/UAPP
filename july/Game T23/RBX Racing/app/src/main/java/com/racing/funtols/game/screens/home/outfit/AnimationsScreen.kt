...
import com.racing.funtols.game.actors.panel.outfit.data.AnimationsCategory
import com.racing.funtols.game.actors.panel.outfit.data.AnimationsData
...
class AnimationsScreen: AdvancedScreen() {
    ...
    private fun AConstraintLayout.addPanelTop() {
        ...
        aPanelTop.setTitle("ALL ANIMATION")
    }
