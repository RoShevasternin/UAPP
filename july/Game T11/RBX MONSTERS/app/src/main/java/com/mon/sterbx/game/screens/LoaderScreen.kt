...
import com.mon.sterbx.game.actors.loader.ALoaderGroup
...
class LoaderScreen : AdvancedScreen() {
    ...
    override fun AConstraintLayout.addActorsOnRootConstraintLayout() {
        ...
        aBottomTextImg.setSize(336f, 66f)
    ...
    private fun AConstraintLayout.setupVideoBackground() {
        runCatching {
            val videoPlayer = VideoPlayerCreator.createVideoPlayer().apply {
                ...
                load(Gdx.files.internal("video/background.mp4"))
                play()
            }
        ...
        coroutine?.launch {
            ...
            progressFlow.collect { p ->
                while (progress < (p * 100)) {
                    ...
                    aMain.aProgress.setProgressPercent(progress.toFloat())
