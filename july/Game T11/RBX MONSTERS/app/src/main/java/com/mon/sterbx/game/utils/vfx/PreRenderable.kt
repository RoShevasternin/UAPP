package com.mon.sterbx.game.utils.vfx
...
//   бо сам preRender() через [com.mon.sterbx.game.utils.advanced.preRenderGroup.PreRenderableGroup.preRenderChildren] рекурсивно обробить своїх дітей.
