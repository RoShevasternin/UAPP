...
import com.mon.sterbx.game.actors.panel.selector.APanelSelectorVertical
import com.mon.sterbx.game.actors.panel.selector.data.NamesData
...
class Selector_4_Screen: AdvancedScreen() {
    ...
    private val aContinueBtn by lazy { AOrangeButton(this, "START") }
