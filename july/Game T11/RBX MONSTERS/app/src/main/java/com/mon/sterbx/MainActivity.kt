...
import com.mon.sterbx.adsmodule.AdConfig
import com.mon.sterbx.adsmodule.AdManager
import com.mon.sterbx.adsmodule.AdSizeManager
import com.mon.sterbx.adsmodule.AppOpenManager
import com.mon.sterbx.adsmodule.RemoteConfigModel
import com.mon.sterbx.adsmodule.UserDetector
import com.mon.sterbx.databinding.ActivityMainBinding
import com.mon.sterbx.game.utils.runGDX
import com.mon.sterbx.services.tiktok.TikTokManager
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun openPrivacyPolicy() {
        runOnUiThread {
            val url = "https://doc-hosting.flycricket.io/rbx-monsters-privacy-policy/0fa7bf9a-01d6-4d14-ba99-9cd3c79bfa76/privacy"
            try {
                startActivity(
                    Intent(Intent.ACTION_VIEW).apply {
                        data  = url.toUri()
    ...
    private fun fetchRemoteConfig(onComplete: (success: Boolean) -> Unit) {
        ...
        remoteConfig.fetchAndActivate().addOnCompleteListener(this) { task ->
            if (task.isSuccessful) {
                runCatching {
                    val json = remoteConfig.getString("defus")
