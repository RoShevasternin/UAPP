...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumTexture(val data: TextureData) {
        ...
        // ALL
        BACKGROUND_YELLOW(TextureData("textures/all/background_yellow.png")),
        ...
        PANEL_CONVERTER_2     (TextureData("textures/all/panel/panel_converter_2.png")),
        ...
        MONSTER     (TextureData("textures/all/quiz/monster.png")),
        ...
        // All | quess
        FAIL (TextureData("textures/all/guess/fail.png")),
        GUESS(TextureData("textures/all/guess/guess.png")),
        WIN  (TextureData("textures/all/guess/win.png")),
    }
    ...
    enum class EnumTextureGroup(
        ...
        CLOTHING   ("textures/all/selector/clothing"  , "" , 6 , ""),
        ANIMATIONS ("textures/all/selector/animation" , "" , 6, ""),
        CHARACTER  ("textures/all/selector/character" , "" , 6 , ""),

        HOME_CONTENT("textures/all/home", "content", 6),

        CHARACTER_BIG("textures/all/character" , "" , 6 , ""),

        OUTFIT_CLOTHING   ("textures/all/outfit/clothing"     , "" , 24, ""),
        OUTFIT_ACCESSORIES("textures/all/outfit/accessories"  , "" , 18, ""),
